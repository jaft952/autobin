...
FORWARD_HIGH_SPEED = 27.0       # hand-tested cruise speed at/beyond FAR_DISTANCE
FORWARD_MID_SPEED = 25.0        # hand-tested speed between FAR_DISTANCE_CM and MID_DISTANCE_CM
FORWARD_LOW_SPEED = 23.0        # used only when distance can't be estimated at all

BACKUP_SPEED = 35.0             # gentle reverse to recover from an overshoot
