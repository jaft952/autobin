...
MAX_SPEED = 23.0             # TODO tune: matches MotionCalibration's default arc_speed
FALLBACK_SPEED = 23.0        # TODO tune: used only when distance can't be estimated at all
BACKUP_SPEED = 23.0          # TODO tune: gentle reverse to recover from an overshoot
