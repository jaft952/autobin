...
FORWARD_HIGH_SPEED = 40.0       # hand-tested cruise speed at/beyond FAR_DISTANCE
FORWARD_MID_SPEED = 38.0        # hand-tested speed between FAR_DISTANCE_CM and MID_DISTANCE_CM
FORWARD_LOW_SPEED = 36.0        # used only when distance can't be estimated at all
