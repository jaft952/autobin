...
APPROACH_SPEED = 15.0        # TODO tune: hand-tested speed between FAR_DISTANCE_CM and CRUISE_DISTANCE_CM
...
STEP_SPEED = 10.0            # TODO tune: hand-tested fixed nudge speed for step-and-look
