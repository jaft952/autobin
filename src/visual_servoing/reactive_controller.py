...
FORWARD_MID_SPEED = 52.0        # hand-tested speed between FAR_DISTANCE_CM and MID_DISTANCE_CM
FORWARD_LOW_SPEED = 50.0        # used only when distance can't be estimated at all
