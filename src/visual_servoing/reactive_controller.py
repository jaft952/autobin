...
MAX_SPEED = 20.0             # TODO tune: hand-tested cruise speed at/beyond CRUISE_DISTANCE_CM
APPROACH_SPEED = 22.0        # TODO tune: hand-tested speed between FAR_DISTANCE_CM and CRUISE_DISTANCE_CM
