"""Perception to target error. Pure function on DetectionResult, no hardware needed."""
...
CLOSE_BBOX_FRACTION = 0.75 # fraction of frame_height; TODO tune
...
def compute_target_error(detection: DetectionResult,
    ...
    """ultrasonic_cm reserved for future vision+ultrasonic fusion; pass None today."""
    ...
    # prefer segmented pixel count over bbox area, which overstates footprint
