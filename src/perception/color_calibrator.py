"""Tunes HSV bounds for the 4 gripper colors, saved to config/color_config.yaml."""
...
def main():
    ...
    # load existing config, or bail if missing
    ...
    while True:
        ...
        # sync trackbars when color selection changes
