"""Obstacle avoidance decisions from sensor readings."""
...
def pick_pivot_side(turning_left: bool, intended_room_cm: float,
    ...
    """Pick the turn side. Switch only if the other side has much more room."""
...
def compare_room(left_cm: float, right_cm: float, *, roomy_cm: float,
    ...
    """True if the left has more room, False for right, None for a tie."""
